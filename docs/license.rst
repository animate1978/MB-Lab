...
All data files released in the MB-Lab package, including all the meshes and data contained in .blend files or in any other 3d file format (for example .obj and .mtl), all the images and all the json files are released under GNU Affero General Public License 3.
